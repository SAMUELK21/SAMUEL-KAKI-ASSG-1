...
\begin{equation}
In-centre \ {\textbf{I}} = \frac{\textbf{a}\norm{\vec{A}}+\textbf{b}\norm{\vec{B}}+\textbf{c}\norm{\vec{C}}}{\textbf{a}+\textbf{b}+\textbf{c}}\\
\end{equation}
\begin{equation}
\textbf{I} = \myvec{\frac{181.73}{64.75}\\\frac{132.15}{64.75}}
\end{equation}
\begin{align}
\textbf{I} = \myvec{2.8\\2.1}
\end{align}
\begin{center}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\columnwidth]{Incentre of triangle.png}
